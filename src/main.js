...
import { initVoiceCommands } from './voice/geminiLive.js';
...
async function init() {
  ...
  try {
    ...
    window.__godsEyeView.voiceCommands = initVoiceCommands({ viewer, styleManager, dataManager, sceneDirector, annotations });
